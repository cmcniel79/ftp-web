...
export class PremiumPageComponent extends Component {
  constructor(props) {
    super(props);
...
PremiumPageComponent.defaultProps = {
...
PremiumPageComponent.propTypes = {
  // from withRouter
  history: shape({
...
PremiumPage.setInitialValues = initialValues => setInitialValues(initialValues);
PremiumPage.loadData = loadData;
