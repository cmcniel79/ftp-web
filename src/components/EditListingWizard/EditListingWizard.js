...
class EditListingWizard extends Component {
  ...
  render() {
    ...
    const userCountry = currentUserLoaded && ensuredCurrentUser.attributes.profile.publicData.country ?
      ensuredCurrentUser.attributes.profile.publicData.country : "United States";
